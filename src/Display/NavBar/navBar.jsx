          ...
          <div className="hidden md:flex items-center justify-between w-[900px] border flex-row flex-wrap">
            <div className="flex items-center justify-center gap-8 p-2 flex-row w-[680px] h-[49px] flex-wrap border border-gray-600 rounded-full bg-gray-500">
              <div className="group cursor-pointer">
                <Link
                  to="/"
                  className="font-sans font-normal text-white text-[16px] relative 
            ...
            <div onClick={() => navigate("/login")} className="flex items-center justify-center gap-2 p-2 w-[106px] h-[40px] border text-white border-white rounded-[8px] hover:bg-white hover:text-black cursor-pointer">
              <div className="flex items-center justify-center">
